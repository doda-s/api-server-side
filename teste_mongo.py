...
uri = "mongodb+srv://gustavopaterno1:E910vzSF1OYgJI8I@jpg2.oaxxecf.mongodb.net/?retryWrites=true&w=majority&tls=true"
...
def get_alunos():
    alunos = list(jogadores.find({}, {"_id": 0}))  
...
def post_aluno():
    ...
    jogadores.insert_one(new_usuario)
